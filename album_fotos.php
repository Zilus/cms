								...
								foreach($rows as &$row) {
									...
									echo '<tr>
											...
											<td style="text-align:center">	
												<a href="'.$action.'?id='.$row['foto_id'].'&album='.$row_a['album_id'].'"><img src="images/icons/'.$img.'" title="Status" /></a>					
												
												<a href="foto_delete.php?id='.$row['foto_id'].'&album='.$row_a['album_id'].'" OnClick="return Confirm();"><img src="images/icons/cross.png" title="Eliminar" /></a>										
											</td>                        
										</tr>';	
								}	
                            ?>   
